...
return ( <form onSubmit={handleSubmit} className="space-y-6"> <div> <label
       htmlFor="title"
...
Title </label>
    ...
    <input
      ...
      placeholder="e.g. Program Registration"
  ...
  <div>
    ...
    <textarea
      ...
      placeholder="e.g. Tell people what this form is about"
      rows={4}
      className="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-gray-900 outline-none placeholder:text-gray-400 focus:border-black"
    />
